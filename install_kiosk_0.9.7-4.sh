#!/bin/bash
################################################################################
###   Ubuntu Based Kiosk (UBK) v0.9.7-4       ###
################################################################################
#
# RELEASE v0.9.7-4 - Navigation Menu & Gesture Improvements
# - Fixed virtual console Ctrl+Alt+F1-F8 key combinations
# - Added URL naming feature for friendly site names
# - Added navigation hot corner menu (top left)
# - Swapped hidden tab gestures: 3-finger DOWN=show, 3-finger UP=return
# - Enhanced site navigation with visual quick reference
#
